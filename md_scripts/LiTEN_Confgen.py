...
def main(args):
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        calculator = LiTENCalculator(model_name=args.model_name, is_pbc=False, is_batch=True, data=batch, **config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='/home/suqun/model/LiTEN-FF/example/under_25', help='Input structure file')
