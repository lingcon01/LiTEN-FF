...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, default='/home/suqun/model/LiTEN-FF/example/dipe.xyz',
                        help='Input structure file')
    parser.add_argument('--output_file', type=str, default='/home/suqun/model/LiTEN-FF/example/dipe_opt.xyz',
